...
def convert():
    ...
    CLOSED_CLASS = {
        ...
        'GIA': [('ADV', [])],
        'COME': [('ADV', []), ('CONJ', []), ('PREP', [])],
        # Preposizioni articolate: DI + article
        'DEL': [('PREP', ['masc', 'sg']), ('DET', ['masc', 'sg'])],
        'DELLA': [('PREP', ['fem', 'sg']), ('DET', ['fem', 'sg'])],
        'DEI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'DEGLI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'DELLE': [('PREP', ['fem', 'pl']), ('DET', ['fem', 'pl'])],
        'DELL': [('PREP', []), ('DET', [])],
        # Preposizioni articolate: IN + article
        'NEL': [('PREP', ['masc', 'sg']), ('DET', ['masc', 'sg'])],
        'NELLA': [('PREP', ['fem', 'sg']), ('DET', ['fem', 'sg'])],
        'NEI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'NEGLI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'NELLE': [('PREP', ['fem', 'pl']), ('DET', ['fem', 'pl'])],
        'NELL': [('PREP', []), ('DET', [])],
        # Preposizioni articolate: A + article
        'AL': [('PREP', ['masc', 'sg']), ('DET', ['masc', 'sg'])],
        'ALLA': [('PREP', ['fem', 'sg']), ('DET', ['fem', 'sg'])],
        'AI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'ALLE': [('PREP', ['fem', 'pl']), ('DET', ['fem', 'pl'])],
        'ALL': [('PREP', []), ('DET', [])],
        # Preposizioni articolate: DA + article
        'DAL': [('PREP', ['masc', 'sg']), ('DET', ['masc', 'sg'])],
        'DALLA': [('PREP', ['fem', 'sg']), ('DET', ['fem', 'sg'])],
        'DAI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'DALLE': [('PREP', ['fem', 'pl']), ('DET', ['fem', 'pl'])],
        'DALL': [('PREP', []), ('DET', [])],
        # Preposizioni articolate: SU + article
        'SUL': [('PREP', ['masc', 'sg']), ('DET', ['masc', 'sg'])],
        'SULLA': [('PREP', ['fem', 'sg']), ('DET', ['fem', 'sg'])],
        'SUI': [('PREP', ['masc', 'pl']), ('DET', ['masc', 'pl'])],
        'SULLE': [('PREP', ['fem', 'pl']), ('DET', ['fem', 'pl'])],
        'SULL': [('PREP', []), ('DET', [])],
        # Preposizioni articolate: CON + article
        'COL': [('PREP', ['masc', 'sg'])],
        'COLLA': [('PREP', ['fem', 'sg'])],
        'COI': [('PREP', ['masc', 'pl'])],
        'COLLE': [('PREP', ['fem', 'pl'])],
        # Preposizioni articolate: PER + article
        'PEL': [('PREP', ['masc', 'sg'])],
        'PELLE': [('PREP', ['fem', 'pl'])],
        # Preposizioni articolate: TRA/FRA + article
        'TRA': [('PREP', [])],
        'FRA': [('PREP', [])],
    }
    ...
    NOUNS = {
        ...
        'OBBLIGO': ('masc', 'sg'), 'OBBLIGHI': ('masc', 'pl'),
        ...
        'RAPPORTO': ('masc', 'sg'), 'RAPPORTI': ('masc', 'pl'),
        'DECISIONE': ('fem', 'sg'), 'DECISIONI': ('fem', 'pl'),
        'PROVVEDIMENTO': ('masc', 'sg'),
        'SENTENZA': ('fem', 'sg'), 'SENTENZE': ('fem', 'pl'),
        'NORMA': ('fem', 'sg'), 'NORME': ('fem', 'pl'),
        'PRINCIPIO': ('masc', 'sg'), 'PRINCIPI': ('masc', 'pl'),
        ...
        'FINESTRA': ('fem', 'sg'), 'FINESTRE': ('fem', 'pl'),
        # Legal/political nouns
        'REPUBBLICA': ('fem', 'sg'), 'REPUBBLICHE': ('fem', 'pl'),
        'FORMAZIONE': ('fem', 'sg'), 'FORMAZIONI': ('fem', 'pl'),
        'PERSONALITA': ('fem', 'sg'),
        'SINGOLO': ('masc', 'sg'), 'SINGOLI': ('masc', 'pl'),
        'DIRITTO-DIR': ('masc', 'sg'),
        'VIGORE': ('masc', 'sg'),
        'MOMENTO': ('masc', 'sg'), 'MOMENTI': ('masc', 'pl'),
        'ADEMPIENTO': ('masc', 'sg'),
        'RESPONSABILITA': ('fem', 'sg'),
        'DISPOSIZIONE': ('fem', 'sg'), 'DISPOSIZIONI': ('fem', 'pl'),
        'LEGISLAZIONE': ('fem', 'sg'),
        'ESECUZIONE': ('fem', 'sg'), 'ESECUZIONI': ('fem', 'pl'),
        'INADEMPIMENTO': ('masc', 'sg'),
        'COMITATO': ('masc', 'sg'), 'COMITATI': ('masc', 'pl'),
        'COMMISSIONE': ('fem', 'sg'), 'COMMISSIONI': ('fem', 'pl'),
        'COSTITUZIONE': ('fem', 'sg'),
        'PARLAMENTO': ('masc', 'sg'),
        'SENATO': ('masc', 'sg'),
        'CAMERA': ('fem', 'sg'), 'CAMERE': ('fem', 'pl'),
        'REGIONE': ('fem', 'sg'), 'REGIONI': ('fem', 'pl'),
        'PROVINCIA': ('fem', 'sg'), 'PROVINCE': ('fem', 'pl'),
        'COMUNE': ('masc', 'sg'), 'COMUNI': ('masc', 'pl'),
        'ELEZIONE': ('fem', 'sg'), 'ELEZIONI': ('fem', 'pl'),
        'VOTO': ('masc', 'sg'), 'VOTI': ('masc', 'pl'),
        'RIFORMA': ('fem', 'sg'), 'RIFORME': ('fem', 'pl'),
        'SOCIETA': ('fem', 'sg'), 'SOCIETA': ('fem', 'pl'),
        'DIRITTO-DIRITTO': ('masc', 'sg'),
        'GARANZIA': ('fem', 'sg'), 'GARANZIE': ('fem', 'pl'),
        'LIBERTA': ('fem', 'sg'),
        'UGUAGLIANZA': ('fem', 'sg'),
        'GIUSTIZIA': ('fem', 'sg'),
        'SICUREZZA': ('fem', 'sg'),
        ...
        'SVILUPPO': ('masc', 'sg'),
        'PROGRESSO': ('masc', 'sg'),
        'CULTURA': ('fem', 'sg'), 'CULTURE': ('fem', 'pl'),
        'EDUCAZIONE': ('fem', 'sg'),
        'ISTRUZIONE': ('fem', 'sg'),
        'UNIVERSITA': ('fem', 'sg'),
        'RICERCA': ('fem', 'sg'), 'RICERCHE': ('fem', 'pl'),
        'SCIENZA': ('fem', 'sg'), 'SCIENZE': ('fem', 'pl'),
        'TECNOLOGIA': ('fem', 'sg'), 'TECNOLOGIE': ('fem', 'pl'),
        'INFORMAZIONE': ('fem', 'sg'), 'INFORMAZIONI': ('fem', 'pl'),
        'SISTEMA': ('masc', 'sg'), 'SISTEMI': ('masc', 'pl'),
        'PROGETTO': ('masc', 'sg'), 'PROGETTI': ('masc', 'pl'),
        'PROGRAMMA': ('masc', 'sg'), 'PROGRAMMI': ('masc', 'pl'),
        'PIANO': ('masc', 'sg'), 'PIANI': ('masc', 'pl'),
        'STRUTTURA': ('fem', 'sg'), 'STRUTTURE': ('fem', 'pl'),
        'ORGANIZZAZIONE': ('fem', 'sg'),
        'FUNZIONE': ('fem', 'sg'), 'FUNZIONI': ('fem', 'pl'),
        'ATTIVITA': ('fem', 'sg'),
        'SERVIZIO': ('masc', 'sg'), 'SERVIZI': ('masc', 'pl'),
        'PRESTAZIONE': ('fem', 'sg'), 'PRESTAZIONI': ('fem', 'pl'),
        'CONOSCENZA': ('fem', 'sg'), 'CONOSCENZE': ('fem', 'pl'),
        'ESPRIENZA': ('fem', 'sg'), 'ESPRIENZE': ('fem', 'pl'),
        'IDEA': ('fem', 'sg'), 'IDEE': ('fem', 'pl'),
        'OPINIONE': ('fem', 'sg'), 'OPINIONI': ('fem', 'pl'),
        'POSIZIONE': ('fem', 'sg'), 'POSIZIONI': ('fem', 'pl'),
        'SITUAZIONE': ('fem', 'sg'), 'SITUAZIONI': ('fem', 'pl'),
        'CONDIZIONE': ('fem', 'sg'), 'CONDIZIONI': ('fem', 'pl'),
        'QUALITA': ('fem', 'sg'),
        'QUANTITA': ('fem', 'sg'),
        'PROBLEMA': ('masc', 'sg'), 'PROBLEMI': ('masc', 'pl'),
        'DOMANDA': ('fem', 'sg'), 'DOMANDE': ('fem', 'pl'),
        'RISPOSTA': ('fem', 'sg'), 'RISPOSTE': ('fem', 'pl'),
        'SOLUZIONE': ('fem', 'sg'), 'SOLUZIONI': ('fem', 'pl'),
        'RISULTATO': ('masc', 'sg'), 'RISULTATI': ('masc', 'pl'),
        'EFFETTO': ('masc', 'sg'), 'EFFETTI': ('masc', 'pl'),
        'CONSEGUENZA': ('fem', 'sg'), 'CONSEGUENZE': ('fem', 'pl'),
        'MOTIVO': ('masc', 'sg'), 'MOTIVI': ('masc', 'pl'),
        'RAGIONE': ('fem', 'sg'), 'RAGIONI': ('fem', 'pl'),
        'NECESSITA': ('fem', 'sg'),
        'IMPORTANZA': ('fem', 'sg'),
        'DIFFERENZA': ('fem', 'sg'), 'DIFFERENZE': ('fem', 'pl'),
        'RELAZIONE': ('fem', 'sg'), 'RELAZIONI': ('fem', 'pl'),
        'CONNESSIONE': ('fem', 'sg'), 'CONNESSIONI': ('fem', 'pl'),
        'DANNO': ('masc', 'sg'), 'DANNI': ('masc', 'pl'),
        'RISARCIMENTO': ('masc', 'sg'),
        'PAGAMENTO': ('masc', 'sg'), 'PAGAMENTI': ('masc', 'pl'),
        'PREZZO': ('masc', 'sg'), 'PREZZI': ('masc', 'pl'),
        'VALORE': ('masc', 'sg'), 'VALORI': ('masc', 'pl'),
        'SOMMA': ('fem', 'sg'), 'SOMME': ('fem', 'pl'),
        'IMPORTO': ('masc', 'sg'), 'IMPORTI': ('masc', 'pl'),
        'TASSO': ('masc', 'sg'), 'TASSI': ('masc', 'pl'),
        'INTERESSE': ('masc', 'sg'), 'INTERESSI': ('masc', 'pl'),
        'PROPRIETA': ('fem', 'sg'),
        'POSSESSO': ('masc', 'sg'),
        'BENE': ('masc', 'sg'), 'BENI': ('masc', 'pl'),
        'COSA': ('fem', 'sg'), 'COSE': ('fem', 'pl'),
        'MATERIA': ('fem', 'sg'), 'MATERIE': ('fem', 'pl'),
        'ELEMENTO': ('masc', 'sg'), 'ELEMENTI': ('masc', 'pl'),
        'PARTECIPAZIONE': ('fem', 'sg'),
        'RAPPRESENTANZA': ('fem', 'sg'),
        'PROCESSO': ('masc', 'sg'), 'PROCESSI': ('masc', 'pl'),
        'GIUDIZIO': ('masc', 'sg'), 'GIUDIZI': ('masc', 'pl'),
        'INDAGINE': ('fem', 'sg'), 'INDAGINI': ('fem', 'pl'),
        'PROVA': ('fem', 'sg'), 'PROVE': ('fem', 'pl'),
        'TESTIMONE': ('masc', 'sg'), 'TESTIMONI': ('masc', 'pl'),
        'AVVOCATO': ('masc', 'sg'), 'AVVOCATI': ('masc', 'pl'),
        'NOTAIO': ('masc', 'sg'), 'NOTAI': ('masc', 'pl'),
        'IMPUTATO': ('masc', 'sg'), 'IMPUTATI': ('masc', 'pl'),
        'CONDANNA': ('fem', 'sg'), 'CONDANNE': ('fem', 'pl'),
        'PENA': ('fem', 'sg'), 'PENE': ('fem', 'pl'),
        'CRIMINE': ('masc', 'sg'), 'CRIMINI': ('masc', 'pl'),
        'REATO': ('masc', 'sg'), 'REATI': ('masc', 'pl'),
        'VIOLAZIONE': ('fem', 'sg'), 'VIOLAZIONI': ('fem', 'pl'),
        'DEROGA': ('fem', 'sg'), 'DEROGHE': ('fem', 'pl'),
    }
    ...
    ADJS = {
        ...
        'INVIOLABILE': [('INVIOLABILE', 'masc', 'sg'), ('INVIOLABILE', 'fem', 'sg'), ('INVIOLABILI', 'masc', 'pl'), ('INVIOLABILI', 'fem', 'pl')],
        'SOCIALE': [('SOCIALE', 'masc', 'sg'), ('SOCIALE', 'fem', 'sg'), ('SOCIALI', 'masc', 'pl'), ('SOCIALI', 'fem', 'pl')],
        'SINGOLO': [('SINGOLO', 'masc', 'sg'), ('SINGOLA', 'fem', 'sg'), ('SINGOLI', 'masc', 'pl'), ('SINGOLE', 'fem', 'pl')],
        'DERIVANTE': [('DERIVANTE', 'masc', 'sg'), ('DERIVANTE', 'fem', 'sg'), ('DERIVANTI', 'masc', 'pl'), ('DERIVANTI', 'fem', 'pl')],
        'COMPLETO': [('COMPLETO', 'masc', 'sg'), ('COMPLETA', 'fem', 'sg'), ('COMPLETI', 'masc', 'pl'), ('COMPLETE', 'fem', 'pl')],
        'VALIDO': [('VALIDO', 'masc', 'sg'), ('VALIDA', 'fem', 'sg'), ('VALIDI', 'masc', 'pl'), ('VALIDE', 'fem', 'pl')],
        'PRESENTO': [('PRESENTE', 'masc', 'sg'), ('PRESENTE', 'fem', 'sg'), ('PRESENTI', 'masc', 'pl'), ('PRESENTI', 'fem', 'pl')],
        'PRESENTE': [('PRESENTE', 'masc', 'sg'), ('PRESENTE', 'fem', 'sg'), ('PRESENTI', 'masc', 'pl'), ('PRESENTI', 'fem', 'pl')],
        'ENTRAMBO': [('ENTRAMBI', 'masc', 'pl'), ('ENTRAMBE', 'fem', 'pl')],
        'POSSIBILE': [('POSSIBILE', 'masc', 'sg'), ('POSSIBILE', 'fem', 'sg'), ('POSSIBILI', 'masc', 'pl'), ('POSSIBILI', 'fem', 'pl')],
        'NECESSARIO': [('NECESSARIO', 'masc', 'sg'), ('NECESSARIA', 'fem', 'sg'), ('NECESSARI', 'masc', 'pl'), ('NECESSARIE', 'fem', 'pl')],
        'IMPORTANTE': [('IMPORTANTE', 'masc', 'sg'), ('IMPORTANTE', 'fem', 'sg'), ('IMPORTANTI', 'masc', 'pl'), ('IMPORTANTI', 'fem', 'pl')],
        'DIVERSO': [('DIVERSO', 'masc', 'sg'), ('DIVERSA', 'fem', 'sg'), ('DIVERSI', 'masc', 'pl'), ('DIVERSE', 'fem', 'pl')],
        'CERTO': [('CERTO', 'masc', 'sg'), ('CERTA', 'fem', 'sg'), ('CERTI', 'masc', 'pl'), ('CERTE', 'fem', 'pl')],
        'STESSO': [('STESSO', 'masc', 'sg'), ('STESSA', 'fem', 'sg'), ('STESSI', 'masc', 'pl'), ('STESSE', 'fem', 'pl')],
        'PROPRIO': [('PROPRIO', 'masc', 'sg'), ('PROPRIA', 'fem', 'sg'), ('PROPRI', 'masc', 'pl'), ('PROPRIE', 'fem', 'pl')],
        'GENERALE': [('GENERALE', 'masc', 'sg'), ('GENERALE', 'fem', 'sg'), ('GENERALI', 'masc', 'pl'), ('GENERALI', 'fem', 'pl')],
        'SPECIALE': [('SPECIALE', 'masc', 'sg'), ('SPECIALE', 'fem', 'sg'), ('SPECIALI', 'masc', 'pl'), ('SPECIALI', 'fem', 'pl')],
        'PARTICOLARE': [('PARTICOLARE', 'masc', 'sg'), ('PARTICOLARE', 'fem', 'sg'), ('PARTICOLARI', 'masc', 'pl'), ('PARTICOLARI', 'fem', 'pl')],
        'GIOVANE': [('GIOVANE', 'masc', 'sg'), ('GIOVANE', 'fem', 'sg'), ('GIOVANI', 'masc', 'pl'), ('GIOVANI', 'fem', 'pl')],
        'VECCHIO': [('VECCHIO', 'masc', 'sg'), ('VECCHIA', 'fem', 'sg'), ('VECCHI', 'masc', 'pl'), ('VECCHIE', 'fem', 'pl')],
        'NUDO': [('NUDO', 'masc', 'sg'), ('NUDA', 'fem', 'sg'), ('NUDI', 'masc', 'pl'), ('NUDE', 'fem', 'pl')],
        'VERO': [('VERO', 'masc', 'sg'), ('VERA', 'fem', 'sg'), ('VERI', 'masc', 'pl'), ('VERE', 'fem', 'pl')],
        'FALSO': [('FALSO', 'masc', 'sg'), ('FALSA', 'fem', 'sg'), ('FALSI', 'masc', 'pl'), ('FALSE', 'fem', 'pl')],
        'DURO': [('DURO', 'masc', 'sg'), ('DURA', 'fem', 'sg'), ('DURI', 'masc', 'pl'), ('DURE', 'fem', 'pl')],
        'FACILE': [('FACILE', 'masc', 'sg'), ('FACILE', 'fem', 'sg'), ('FACILI', 'masc', 'pl'), ('FACILI', 'fem', 'pl')],
        'DIFFICILE': [('DIFFICILE', 'masc', 'sg'), ('DIFFICILE', 'fem', 'sg'), ('DIFFICILI', 'masc', 'pl'), ('DIFFICILI', 'fem', 'pl')],
        'COMUNE': [('COMUNE', 'masc', 'sg'), ('COMUNE', 'fem', 'sg'), ('COMUNI', 'masc', 'pl'), ('COMUNI', 'fem', 'pl')],
        'PUBBLICO': [('PUBBLICO', 'masc', 'sg'), ('PUBBLICA', 'fem', 'sg'), ('PUBBLICI', 'masc', 'pl'), ('PUBBLICHE', 'fem', 'pl')],
        'PRIVATO': [('PRIVATO', 'masc', 'sg'), ('PRIVATA', 'fem', 'sg'), ('PRIVATI', 'masc', 'pl'), ('PRIVATE', 'fem', 'pl')],
        'POLITICO': [('POLITICO', 'masc', 'sg'), ('POLITICA', 'fem', 'sg'), ('POLITICI', 'masc', 'pl'), ('POLITICHE', 'fem', 'pl')],
        'ECONOMICO': [('ECONOMICO', 'masc', 'sg'), ('ECONOMICA', 'fem', 'sg'), ('ECONOMICI', 'masc', 'pl'), ('ECONOMICHE', 'fem', 'pl')],
        'LEGALE': [('LEGALE', 'masc', 'sg'), ('LEGALE', 'fem', 'sg'), ('LEGALI', 'masc', 'pl'), ('LEGALI', 'fem', 'pl')],
        'APPLICABILE': [('APPLICABILE', 'masc', 'sg'), ('APPLICABILE', 'fem', 'sg'), ('APPLICABILI', 'masc', 'pl'), ('APPLICABILI', 'fem', 'pl')],
        'INESATTO': [('INESATTO', 'masc', 'sg'), ('INESATTA', 'fem', 'sg'), ('INESATTI', 'masc', 'pl'), ('INESATTE', 'fem', 'pl')],
        'RESPONSABILE': [('RESPONSABILE', 'masc', 'sg'), ('RESPONSABILE', 'fem', 'sg'), ('RESPONSABILI', 'masc', 'pl'), ('RESPONSABILI', 'fem', 'pl')],
        'AMMINISTRATIVO': [('AMMINISTRATIVO', 'masc', 'sg'), ('AMMINISTRATIVA', 'fem', 'sg'), ('AMMINISTRATIVI', 'masc', 'pl'), ('AMMINISTRATIVE', 'fem', 'pl')],
        'GIURIDICO': [('GIURIDICO', 'masc', 'sg'), ('GIURIDICA', 'fem', 'sg'), ('GIURIDICI', 'masc', 'pl'), ('GIURIDICHE', 'fem', 'pl')],
    }
    ...
    for lemma in sorted(data.keys()):
        for pos in data[lemma]:
            ...
            # Sort: put the lemma form first so paradigm[0] flexia produces
            # the correct stored lemma. Prefer forms that exactly match the
            # lemma key, then forms with inf/NFIN tag, then shortest form.
            def _lemma_sort_key(wc):
                w, gc = wc
                gc_info = gramtab["gramcodes"].get(gc, {})
                gc_tags = gc_info.get("g", [])
                # Priority 0: form equals lemma (exact match)
                # Priority 1: infinitive tag
                # Priority 2: shortest form (tiebreak)
                is_exact = 0 if w == lemma else 1
                is_inf = 0 if 'inf' in gc_tags else 1
                return (is_exact, is_inf, len(w))
