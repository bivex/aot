...
# Quick verification for English dictionaries
set -e

PROJECT_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
DICT_DIR="${PROJECT_ROOT}/Dicts/Morph/English"
SOURCE_DIR="${PROJECT_ROOT}/Source/morph_dict/data/English"

echo "=== RML English Dictionary Verification ==="
echo ""
...
words=("rebuild" "restore" "reconstruct" "renew" "repair" "renovate" "refurbish")
