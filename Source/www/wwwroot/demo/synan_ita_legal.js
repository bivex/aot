// ═════════════════════════════════════════════════════════════════════
//  synan_ita_legal.js — D3.js SVG visualization for Italian Legal Documents
// ═════════════════════════════════════════════════════════════════════

var SynanDaemonUrl = 'http://localhost:8089?dummy=1';
var TopClauses = [];
var CURRENT_LANG = 'Italian';
...
function getPosLabel(pos) {
    var labels = { NOUN:'sost.', ADJ:'agg.', VERB:'verbo', ADV:'avv.',
        DET:'art.', PRON:'pron.', PREP:'prep.', CONJ:'cong.',
        INT:'inter.', NUM:'num.', PART:'part.', ADP:'adp.', PROPN:'nome' };
    return labels[pos] || '';
}
function translateDescriptor(d) {
    ...
    var map = {
        'NP':'sint. nom.','VP':'sint. verb.','PP':'sint. prep.',
        'SP':'sogg-pred','VERB_T':'verbo-t',
        'ROOT':'radice','ADJ_NP':'mod.','INF':'inf.',
        'PARTICIPLE_P':'part.'
    };
...
function drawAll() {
    ...
    allSubjArcs.forEach(function(d) {
        ...
        var sTxt = 'SOGETTO', pTxt = 'PREDICATO';
    ...
    [
        { c: GROUP_COLOR,  d: null,  l: '— gruppo sintattico', w: 2 },
        { c: LINK_COLOR,   d: '5,3', l: '- - relazione',       w: 1.5 },
        { c: SP_ARC_COLOR, d: null,  l: '⌢ soggetto-predicato', w: 2.5 },
...
function syntax_request() {
    ...
    if (!query) return;
    fetch(SynanDaemonUrl + '&action=syntax&langua=Italian', { method:'POST', body:query })
        .then(r => r.json())
