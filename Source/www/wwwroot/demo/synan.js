...
function translateDescriptor(d, lang) {
    ...
    var maps = {
        'Ukrainian': {
            'ОТР_ФОРМА': 'заперечна форма', 'ОТР_ФОРМА1': 'заперечна форма',
            'ПРИЛ_СУЩ': 'прикм+іменник', 'ПРИЛ_СУЩ0': 'прикм+іменник', 'ПРИЛ_СУЩ1': 'прикм+іменник', 'ПРИЛ_СУЩ2': 'прикм+іменник',
            'ГЕНИТ_ИГ': 'род. відмінок', 'ГЕНИТ_ИГ1': 'род. відмінок', 'ГЕНИТ_ИГ2': 'род. відмінок',
            'ПРЯМ_ДОП': 'прямий додаток', 'ИНСТР_ДОП': 'орудний додаток',
            'НАРЕЧ_ГЛАГОЛ': 'присл+дієслово', 'ПЕР_ГЛАГ_ИНФ': 'дієсл+інф',
            'ПГ': 'прийм. група', 'ОДНОР_ИГ': 'однорідна група',
            'ГЛ_ЛИЧН': 'особ. форма', 'ДПР': 'дієприслівник',
            'КР_ПРЧ': 'кор. дієприкметник', 'КР_ПРИЛ': 'кор. прикметник',
            'ПРЕДК': 'предикатив', 'ПРЧ': 'дієприкметник', 'ИНФ': 'інфінітив',
            'ВВОД': 'вставне слово', 'ТИРЕ': 'тире', 'ИМ_СКАЗ': 'іменний присудок',
            'КАТ_СОСТ': 'категорія стану', 'НСО': 'невідокр. означення',
            'КОПУЛ': 'зв\'язка', 'НАЗЫВ': 'називне речення',
            'ОБРАЩ': 'звертання', 'ПРЯМ_РЕЧЬ': 'пряма мова',
            'ВСТАВН': 'вставне речення', 'УСЛОВ': 'умова', 'ПОВЕЛ': 'наказ',
            'ВОПРОС': 'питання', 'ВОСКЛ': 'оклик', 'МЕЖД': 'вигук',
            'МОД_СЛОВО': 'модальне слово', 'ЧАСТИЦА': 'частка',
            'ПРИЧ_СУЩ': 'дієприкм+іменник', 'ПРИЛОЖЕНИЕ': 'прикладка',
            'ФИО': 'ПІБ', 'ДОЛЖ_ФИО': 'посада+ПІБ', 'ФРАЗЕОЛ': 'фразеологізм',
            'ОБСТОЯТ': 'обставина', 'ДОПОЛН': 'додаток', 'ОПРЕД': 'означення',
            'ПОДЛЕЖ': 'підмет', 'СКАЗ': 'присудок', 'ГРУППА': 'група'
        },
        'Russian': {
            'ОТР_ФОРМА': 'отрицат. форма', 'ОТР_ФОРМА1': 'отрицат. форма',
            'ПРИЛ_СУЩ': 'прил. + сущ.', 'ПРИЛ_СУЩ0': 'прил. + сущ.', 'ПРИЛ_СУЩ1': 'прил. + сущ.', 'ПРИЛ_СУЩ2': 'прил. + сущ.',
            'ГЕНИТ_ИГ': 'род. падеж', 'ГЕНИТ_ИГ1': 'род. падеж', 'ГЕНИТ_ИГ2': 'род. падеж',
            'ПРЯМ_ДОП': 'прямое дополнение', 'ИНСТР_ДОП': 'творит. дополнение',
            'НАРЕЧ_ГЛАГОЛ': 'нареч. + глагол', 'ПЕР_ГЛАГ_ИНФ': 'глагол + инф.',
            'ПГ': 'предл. группа', 'ОДНОР_ИГ': 'однородная группа',
            'ГЛ_ЛИЧН': 'личная форма', 'ДПР': 'деепричастие',
            ...
            'ВОПРОС': 'вопрос', 'ВОСКЛ': 'восклицание', 'МЕЖД': 'междометие',
            'МОД_СЛОВО': 'модальное слово', 'ЧАСТИЦА': 'частица',
            'ПРИЧ_СУЩ': 'причастие + сущ.', 'ПРИЛОЖЕНИЕ': 'приложение',
            'ФИО': 'ФИО', 'ДОЛЖ_ФИО': 'должность + ФИО', 'ФРАЗЕОЛ': 'фразеологизм',
            'ОБСТОЯТ': 'обстоятельство', 'ДОПОЛН': 'дополнение', 'ОПРЕД': 'определение',
            'ПОДЛЕЖ': 'подлежащее', 'СКАЗ': 'сказуемое', 'ГРУППА': 'группа'
        },
        'English': {
            'NP': 'noun phrase', 'VP': 'verb phrase', 'PP': 'prep phrase',
            'SP': 'subject-predicate', 'VERB_T': 'finite verb',
            'ROOT': 'root', 'SYN_GROUP': 'group'
        }
    };
    var map = maps[lang] || {};
    return map[upper] || d;
