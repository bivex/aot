// ═════════════════════════════════════════════════════════════════════
//  synan_pol_legal.js — D3.js SVG visualization for Polish Legal Documents
// ═════════════════════════════════════════════════════════════════════

var SynanDaemonUrl = 'http://localhost:8089?dummy=1';
var TopClauses = [];
var CURRENT_LANG = 'Polish';
...
function getPosLabel(pos) {
    var labels = { NOUN:'rzecz.', ADJ:'przym.', VERB:'czas.', ADV:'przysł.',
        DET:'określ.', PRON:'zaim.', PREP:'przyim.', CONJ:'spój.',
        INT:'wykrz.', NUM:'liczb.', PART:'part.' };
    return labels[pos] || '';
}
function translateDescriptor(d) {
    ...
    var map = {
        'NP':'grupa rzecz.','VP':'grupa czas.','PP':'przyimek',
        'SP':'podmiot-orzeczenie','VERB_T':'czas-t',
        'ROOT':'rdzeń','ADJ_NP':'określ.'
    };
...
function drawAll() {
    ...
    allSubjArcs.forEach(function(d) {
        ...
        var sTxt = 'PODMIOT', pTxt = 'ORZECZENIE';
    ...
    [
        { c: GROUP_COLOR,  d: null,  l: '— grupa składniowa', w: 2 },
        { c: LINK_COLOR,   d: '5,3', l: '- - związek',           w: 1.5 },
        { c: SP_ARC_COLOR, d: null,  l: '⌢ podmiot-orzeczenie', w: 2.5 },
...
function syntax_request() {
    ...
    if (!query) return;
    fetch(SynanDaemonUrl + '&action=syntax&langua=Polish', { method:'POST', body:query })
        .then(r => r.json())
