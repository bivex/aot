// ═════════════════════════════════════════════════════════════════════
//  synan_fin_legal.js — D3.js SVG visualization for Finnish Legal Documents
// ═════════════════════════════════════════════════════════════════════

var SynanDaemonUrl = 'http://localhost:8089?dummy=1';
var TopClauses = [];
var CURRENT_LANG = 'Finnish';
...
function getPosLabel(pos) {
    var labels = { NOUN:'subst.', ADJ:'adj.', VERB:'verbi', ADV:'adv.',
        DET:'det.', PRON:'pron.', PREP:'prep.', CONJ:'konj.',
        INT:'interj.', NUM:'num.', PART:'part.', ADP:'adp.', PROPN:'nimi' };
    return labels[pos] || '';
}
function translateDescriptor(d) {
    ...
    var map = {
        'NP':'nimilauseke','VP':'verbil.','PP':'postpos.l.',
        'SP':'subj-pred','VERB_T':'verbi-t',
        'ROOT':'juuri','ADJ_NP':'mod.','INF':'inf.',
        'PARTICIPLE_P':'part.'
    };
...
function drawAll() {
    ...
    allSubjArcs.forEach(function(d) {
        ...
        var sTxt = 'SUBJEKTI', pTxt = 'PREDIKAATTI';
    ...
    [
        { c: GROUP_COLOR,  d: null,  l: '— syntaktinen ryhma', w: 2 },
        { c: LINK_COLOR,   d: '5,3', l: '- - yhteys',           w: 1.5 },
        { c: SP_ARC_COLOR, d: null,  l: '⌢ subjekti-predikaatti', w: 2.5 },
...
function syntax_request() {
    ...
    if (!query) return;
    fetch(SynanDaemonUrl + '&action=syntax&langua=Finnish', { method:'POST', body:query })
        .then(r => r.json())
