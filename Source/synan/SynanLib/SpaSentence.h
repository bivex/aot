...
class CSpaSentence : public CSentence
{
public:
	CSpaSentence(const class CSyntaxOpt* m_pSyntaxOptions);
	~CSpaSentence();
	...
	const CSpaSyntaxOpt* GetOpt() const { return (const CSpaSyntaxOpt*)m_pSyntaxOptions; }
	const CSpaGramTab* GetSpaGramTab() const { return (const CSpaGramTab*)GetOpt()->GetGramTab(); }
