...
bool CGraLine::is_lowercase(int ch) const
{
    ...
    else if (m_Language == morphPortuguese)
        return is_portuguese_lower(ch);
    else
...
bool CGraLine::is_latin_alpha(int ch) const
{
    if (m_Language == morphGerman)
        ...
        return is_portuguese_lower(ch) || is_portuguese_upper(ch);
    else
    ...
    if (HasDes(ORLE))
    {
        ...
        if (HasDes(OLLE))
        {
            if (m_Language == morphGerman)
                ...
                return morphLatin;
            else if (m_Language == morphFrench)
                return morphFrench;
            else if (m_Language == morphPortuguese)
                return morphPortuguese;
            else if (m_Language == morphFinnish)
                return morphFinnish;
            else if (m_Language == morphItalian)
                return morphItalian;
            else if (m_Language == morphHungarian)
                return morphHungarian;
            else if (m_Language == morphPolish)
                return morphPolish;
            else
                return morphEnglish;
